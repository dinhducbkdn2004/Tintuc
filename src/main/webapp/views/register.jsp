          ...
          <main class="h-[calc(100vh-150px)]">
            <div class="main-wrapper flex-center h-full">
              <div
                ...
                <h1 class="text-2xl font-extrabold font-playfair text-center text-[#ed1b24]">
                  Tạo tài khoản mới
                </h1>

                <form class="block w-full space-y-3 mt-4" action="<%= path %>/register" method="post">
                  <div class="space-y-1">
                    <label for="name" class="text-sm font-semibold text-gray-700">Họ và tên
                      <span class="text-[#ed1b24]">*</span>
                    </label>
                    <input id="name" name="name" type="text" class="w-full border border-gray-200 rounded p-2 text-sm"
                ...
                <div class="flex items-center justify-center mt-3">
                  ...
                  <a href="<%= path %>/views/login.jsp"
                    class="text-[#ed1b24] font-semibold text-sm ml-1 hover:underline">Đăng nhập ngay.</a>
                </div>
                <!-- <p
